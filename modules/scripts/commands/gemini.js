...
module.exports.config = {
    ...
    usePrefix: false,, // if true it uses the command with the prefix example /testsendimage-url but if false no need prefix can direct use testsendimage-url
    ...
    try {
        ...
        const response = await axios.get(`deku-apis.onrender.com/gemini?prompt=${encodeURIComponent(prompt)}&url=${url}`);
